...
FILES<-dir(path = 'Images/Sample_37_Nat_5_10/',full.names = T)[1:5]
...
FILES<-dir(path = 'Images/Sample_37_Nat_5_10/',full.names = T)
...
saveRDS(areas,file = 'RData/Sample_37_Nat_5_10.RData')
num_agregates <- 5
