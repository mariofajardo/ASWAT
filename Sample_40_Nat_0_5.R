...
FILES<-dir(path = 'Images/Sample_40_Nat_0_5/',full.names = T)[1:5]
...
FILES<-dir(path = 'Images/Sample_40_Nat_0_5/',full.names = T)
...
saveRDS(areas,file = 'RData/Sample_40_Nat_0_5.RData')
num_agregates <- 5
