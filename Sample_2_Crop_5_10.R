...
areas<-foreach(filei=FILES,.packages = 'EBImage') %dopar%  {
  ...
  #display(img)
  num_agregates <- 5
  cutting_area<-list(c(900:1900),c(650:1600))
...
FILES<-dir(path = 'Images/Sample_2_Crop_5_10_2/',full.names = T)[-2]
...
num_agregates <- 5
observations<-c(seq(0,120,1),seq(140,340,20),seq(420,7200,600))
