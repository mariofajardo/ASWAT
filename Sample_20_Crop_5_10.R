...
FILES<-dir(path = 'Images/Sample_20_Crop_5_10/',full.names = T)[1:5]
...
FILES<-dir(path = 'Images/Sample_20_Crop_5_10/',full.names = T)
...
saveRDS(areas,file = 'RData/Sample_20_Crop_5_10')
num_agregates <- 5
