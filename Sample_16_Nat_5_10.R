...
FILES<-dir(path = 'Images/Sample_16_Nat_5_10/',full.names = T)[1:6]
...
FILES<-dir(path = 'Images/Sample_16_Nat_5_10/',full.names = T)
...
saveRDS(areas,file = 'RData/Sample_16_Nat_5_10.RData')
num_agregates <- 5
