...
FILES<-dir(path = 'Images/Sample_10_Nat_0_5/',full.names = T)[1:6]
...
FILES<-dir(path = 'Images/Sample_10_Nat_0_5/',full.names = T)
...
saveRDS(areas,file = 'RData/Sample_10_Nat_0_5.RData')
num_agregates <- 5
