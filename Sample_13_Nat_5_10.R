...
FILES<-dir(path = 'Images/Sample_13_Nat_5_10/',full.names = T)[1:6]
...
FILES<-dir(path = 'Images/Sample_13_Nat_5_10/',full.names = T)
...
areas[[1]]<-areas[[1]][c(2,1,5,4,3)];names(areas[[1]])<-c(1:5)

saveRDS(areas,file = 'RData/Sample_13_Nat_5_10.RData')
num_agregates <- 5
